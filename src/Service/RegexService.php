...
class RegexService
{
    public function __construct(
        #[Autowire(value: '%grin_way_service.start_of_win_sys_file_regex%')]
        protected readonly string $grinWayServiceStartOfWinSysFileRegex,
    ) {
    }
    ...
    */
    ...
    {
        return '~^' . $this->grinWayServiceStartOfWinSysFileRegex . '.*[.]docx?$~ui';
    }
