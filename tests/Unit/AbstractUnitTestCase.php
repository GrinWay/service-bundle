...
abstract class AbstractUnitTestCase extends AbstractTestCase
{
     ...
     * @internal
     */
    protected function setUpCurrencyServiceWithMockedHttpFixerClient()
    {
        $fileClientResponseGenerator = static function (): \Generator {
            while (true) {
        ...
        $this->allCurrencies = \array_keys(self::getContainer()->get('serializer')->decode(static::$mockedGrinWayServiceFixerLatestClientPlainResponse, 'json')['rates'] ?? []);
    }
}
