...
class ForceGetNoBaseFixerApiPayloadTest extends AbstractUnitTestCase
{
    ...
    public function testForceGetNoBaseMockedPayloadToGetNonRemovableCachePayloadItIsImmitationOfAccessTokenExpired()
    {
